const story = {
    ...
    "p2_3": {
        "text": "電風扇的插頭鬆了。天道真晝蹲在桌底，伸出一隻手，要我把椅子挪開。\n\n我以為她要我坐下，便坐了。她從桌底探出頭，看著我，我們一起笑了一聲。我趕快站起來。\n\n「好，現在才可以坐。」\n\n她按了兩次開關，扇葉終於轉動。真晝把風扇朝向我，拿自己的作業紙試風。那張紙的一角畫著很醜的太陽，我問是不是她自畫像，她說比本人差一點。\n\n紙角開始震動。聲音突然變尖，像銀湯匙反覆刮過不鏽鋼碗。我把耳機壓緊，牙齒仍然發酸。\n\n「太強了？」真晝伸手碰開關，停下來等我。\n\nロロ把一張椅子拉到旁邊。她的板子上是心跳數字，底下空著一行。\n\n我剛才明明笑得很自然。現在若說不舒服，會不會連那一下也被算成假的？",
        "phase": "phase-2",
        "choices": [
            {
                "text": "請真晝先把風扇關掉，不必離開。",
    ...
    "p2_4": {
        "text": "走出社辦時，我幾乎撞上湊宵。\n\n她正打著哈欠，手裡的書倒拿著。我指給她看，她翻正，又看了兩行才小聲說：「難怪一直讀不懂。」\n\n她挪開放在椅上的書包，把靠牆的位置讓出來。我坐下，才發現自己一直把膝蓋繃得很緊。\n\n「累了就休息一下。」\n\n她的外套有乾淨枕套的味道。那句話沒有接著問我今天完成了什麼，我竟不知道該把手放在哪裡。\n\n宵的髮絲間垂著一根透明的線。一滴紫色緩緩落下。\n滴答。\n\n我想問她，休息到什麼時候才會開始欠人情。\n\n「醒來再說。」她說。\n\n她怎麼知道我想問什麼？",
        "phase": "phase-2",
        "choices": [
            {
                "text": "「等我能說話了，再問一次，好嗎？」",
    ...
    "p3_1": {
        ...
        "recalls": [
            ...
            },
            {
                "key": "rehearsal",
                "lines": {
                    "signal": "我照那次的樣子拍了一下。絶朝我笑，以為我已經開始替她打拍子。",
                    "laugh": "她還是那樣笑。我幾乎要跟著笑，卻想不起這次有沒有誰說可以慢一點。"
                }
            }
        ]
    },
        ...
        "recalls": [
            {
                "key": "recording",
                "lines": {
                    "name": "我替第一份錄音取過名字。眼前這一段卻已經有了標題，沒有空格等我填。",
                    "off": "頂樓那次，我說不要錄，ロロ便拔下了線。我盯著現在的紅點，等她想起自己做過這件事。"
                }
            }
        ]
    },
        ...
        "recalls": [
            {
                "key": "rehearsal",
                "lines": {
                    "signal": "我還留著那一下停拍的約定。手落下去時，警報把聲音蓋住了。我記得她曾經聽得見。",
                    "laugh": "排練室裡，我們曾經因為太慢而笑出來。這裡的每一下笑聲卻都要更快、更大，才不會被下一聲吞掉。"
                }
            }
        ]
    },
    ...
    "end_ekuro": {
        ...
        "recalls": [
            ...
            },
            {
                "key": "mending",
                "lines": {
                    "lamp": "我替她照過那一小段線。那時她有需要我幫忙的地方，也有我可以放開的時候。現在檯燈找不到了。",
                    "rest": "我們曾經一起坐著，誰也不用被誰照顧。我記得那段安靜的長度，不像這裡，連尾端都摸不到。"
                }
            }
        ]
    },
    ...
    "p1_recording": {
        "phase": "phase-1",
        "text": "「這段先別收。」\n\n我以為霙在跟我說話。門邊的女孩卻先按下錄音機，紅點熄了。\n\n四隈ロロ。她負責留排練紀錄，連我們忘記關風扇的聲音也會收進去。我聽過一次回放，自己的笑聲比想像中尖，便再也不肯戴第二邊耳機。\n\n「檔名？」她問。\n「霙第三次忘詞。」我說。\n霙用劇本輕輕碰了我的手肘。\n\nロロ真的打到一半，抬頭等我。我趕快說只是開玩笑。\n\n她把那幾個字刪掉，沒有笑我反悔。然後把螢幕轉過來，讓我們看見剩下的空格。\n\n「前輩自己的部分，要留下嗎？」",
        "choices": [
            {
                "text": "「留下吧，檔名讓我自己寫。」",
                "next": "p1_4",
            ...
            },
            {
                ...
                "echo": "她拔下麥克風的線。原來停止錄音也可以沒有一大段理由。"
            }
        ]
    },
    "p2_vanity": {
        "phase": "phase-2",
        "next": "p2_2",
        "text": "轉角擺著一張貼滿膠帶的小桌子。鏡見由良坐在桌沿，跟一枚髮夾生氣。\n\n「前輩幫我拿一下。不是鏡子，這個。」\n\n她把蝴蝶結放進我手裡，自己低頭找掉進領口的夾子。我捏著兩邊，把它們拉到一樣高。由良抬頭看了一眼，又故意弄歪。\n\n「這樣才看得出來是由良綁的嘛。」\n\n我說，原來歪掉是簽名。\n她笑了一聲，隨即板起臉，警告我不准在別人面前這樣說。\n\n桌邊放著吃到一半的麵包。她把沒咬過的那一頭轉向我。我沒拿，她也沒追問，只伸手去找唇蜜。\n\n鏡子一直立在我們中間。剛才我幾乎沒注意到。"
    },
    "p3_rehearsal": {
        "phase": "phase-2",
        "text": "閉上眼後，先回來的是排練室地板的觸感。\n\n有一次，赤羽絶把進拍數得太快。我跟不上，便故意把最後一下拍得特別大聲。她停下來，問我是抗議還是改編。\n\n「藝術。」我說。\n\n她抱著手臂想了兩秒，真的重數了一遍。這次慢得我們都笑了。\n\n那天收工後，我們坐在地板上拆鞋帶的死結。絶解不開自己的，卻一直想幫我。她嫌我偷偷笑，抬腳擋住我的視線。\n\n「那下次跟不上，就這樣告訴我。」她拍了一下地板。\n\n我伸手想回拍，椅子扶手卻硌住掌心。宵還坐在旁邊。",
        "choices": [
            {
                "text": "在扶手上輕拍一下，記住那個停拍的約定。",
                "next": "p3_1",
                "memory": {
                    "rehearsal": "signal"
                },
    ...
    "p4_linen": {
        "phase": "phase-3",
        "text": "走廊盡頭有一間小房間。綿瀬絵躯把椅子轉過來，讓我不用面向門外的人。\n\n我坐下，她才彎腰撿起腳邊一顆鈕扣，翻看自己米黃色的袖口。\n\n「又掉了。」\n\n她說是因為老拉著袖子擦桌子。我想起社辦那條總是乾淨的桌邊，問她是不是連上面的貼紙也想擦掉。\n\n「那個不行。由良會生氣。」\n\n絵躯從針線盒拿出一小截線，對著針孔試了幾次。她眼前也有怎麼試都對不準的事情，讓我稍微放鬆了一點。\n\n外頭的腳步停在門口。她沒有催我出去，只把針線盒往旁邊挪，空出一塊桌面。",
        "choices": [
            {
                "text": "把檯燈轉向她。「這樣看得清嗎？」",
                "next": "p4_1",
                ...
                "echo": "她終於穿過針孔，把線拉得很長。我替她按住桌上差點滾走的鈕扣。"
            },
            {
                "text": "「先坐一會兒吧，鈕扣不會跑掉。」",
                "next": "p4_1",
                ...
                "echo": "她把線放回盒裡。我們誰也沒忙著替對方找下一件該做的事。"
            }
        ]
    },
    "p4_waiting": {
        "phase": "phase-4",
        "next": "p4_2",
        "text": "門外有人敲了兩下，等絵躯應聲才推門。\n\n氷堂再把一杯水放在桌上。杯子沒有對準墊子，她重新挪了一次。\n\n我認得這個動作。社團借場地時，我把日期寫錯，是她拿著表格回來找我。那時我說隨便改就好，她卻把筆放在我手邊。\n\n「妳再看一次。改成哪一天？」\n\n我嫌麻煩，還是讀完了。原來空下來的那天，霙不能到。再陪我翻了幾頁行事曆，沒有說自己早就知道。\n\n現在，她把杯子推近一些，問我水溫可不可以。\n\n我碰了碰杯壁。她真的等到我點頭，才放開杯緣。\n\n「另外還有一張紙。」她說。"
    }
};
